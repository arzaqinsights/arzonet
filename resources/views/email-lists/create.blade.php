    ...
    <form action="{{ route('admin.email-lists.store') }}" method="POST" enctype="multipart/form-data" id="wizard-form">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="mb-4">
                    <h2 class="text-base font-black text-surface-800 uppercase">List Intent</h2>
                    <p class="text-[10px] text-surface-500 font-bold mt-2 uppercase">Define the primary use-case for this audience.</p>
                </div>

                <div class="grid grid-cols-3 gap-2">
                    <label class="cursor-pointer group">
                        <input type="radio" name="list_type" value="email" class="hidden peer" checked x-model="listType">
                        <div class="p-3 border-2 border-color rounded-sm bg-white peer-checked:border-brand peer-checked:bg-brand/5 text-center transition-all group-hover:border-brand/30">
                            <svg class="w-6 h-6 mx-auto mb-2 text-surface-400 peer-checked:text-brand" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            <span class="text-[9px] font-black uppercase text-surface-600 block">Email</span>
                        </div>
                    </label>
                    <label class="cursor-pointer group">
                        <input type="radio" name="list_type" value="whatsapp" class="hidden peer" x-model="listType">
                        <div class="p-3 border-2 border-color rounded-sm bg-white peer-checked:border-brand peer-checked:bg-brand/5 text-center transition-all group-hover:border-brand/30">
                            <svg class="w-6 h-6 mx-auto mb-2 text-surface-400 peer-checked:text-brand" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                            <span class="text-[9px] font-black uppercase text-surface-600 block">WhatsApp</span>
                        </div>
                    </label>
                    <label class="cursor-pointer group">
                        <input type="radio" name="list_type" value="dual" class="hidden peer" x-model="listType">
                        <div class="p-3 border-2 border-color rounded-sm bg-white peer-checked:border-brand peer-checked:bg-brand/5 text-center transition-all group-hover:border-brand/30">
                            <svg class="w-6 h-6 mx-auto mb-2 text-surface-400 peer-checked:text-brand" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                            <span class="text-[9px] font-black uppercase text-surface-600 block">Dual</span>
                        </div>
                    </label>
                </div>

                <hr class="border-dashed border-gray-100 my-2">
